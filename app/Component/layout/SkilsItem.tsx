  ...
  return (
    <div className=" mb-[4rem] md:mb-[8rem]">
      ...
      <p className="text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80">
        ...
        corporis fugiat inventore architecto sint, cupiditate totam recusandae,
        velit voluptate ab iusto tempora corrupti adipisci fuga similique
        aliquid eaque numquam officiis!
      </p>
    </div>
  );
};
