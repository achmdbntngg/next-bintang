...
const Footer = () => {
  return (
    <div className="pt-[8rem] pb-[4rem] bg-[#02050a]">
      <div className="grid border-b-[1px] pb-[6rem] grid-cols-1 lg:grid-cols-3 md:grid-cols-2 w-[80%] mx-auto gap-[3rem] ">
        ...
        <div className=" flex items-center space-x-6">
          ...
          <div>
            ...
            <p className="text-[17px] w-[90%] text-white opacity-60">
              achmadbintang501@gmail.com starkdev@gmail.com
            </p>
          </div>
        </div>
      </div>
      <div className=" w-[80%] mt-[2rem] mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-between ">
        <div className="text-[16px] mb-[2rem] md:mb-0 text-white opacity-20">
          StarkDev 2024 | All Rights Reserved
        </div>
